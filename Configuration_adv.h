...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH 5 //2 stock         // Initial retract in mm
                                              // It is a short retract used immediately after print interrupt before move to filament exchange position
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 35  // Unload filament feedrate in mm/s - filament unloading can be fast
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT 120 //45        // Turn off nozzle if user doesn't change filament within this time limit in seconds
